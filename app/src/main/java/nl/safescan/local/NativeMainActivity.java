...
public final class NativeMainActivity extends MainActivity {
    ...
    @Override public void onCreate(Bundle state) {
        ...
        Button about = new Button(this); about.setText(tr("button.about")); styleButton(about, false); about.setOnClickListener(v -> new android.app.AlertDialog.Builder(this).setTitle(tr("button.about")).setMessage(tr("about.info").replace("1.6.4", "1.6.5").replace("1.6.3", "1.6.5")).setPositiveButton(tr("button.close"), null).show()); panel.addView(about);
